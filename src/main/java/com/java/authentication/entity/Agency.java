...
public class Agency {
	...
	public Agency(int agentId,
			@NotNull(message = "agent name cannot be null") @NotEmpty(message = "agent name cannot be empty") String agentName,
			@NotNull(message = " agent address cannot be null") @NotEmpty(message = " agent address cannot be empty") String address1,
			String address2,
			@NotNull(message = "agent state cannot be null") @NotEmpty(message = "agent state cannot be empty") String state,
			@NotNull(message = "agent city cannot be null") @NotEmpty(message = "agent city cannot be empty") String city,
			@NotNull(message = "agent phone number cannot be null") @Pattern(regexp = "^\\d{10}$", message = "invalid agent mobile number") String agentPhoneNumber,
